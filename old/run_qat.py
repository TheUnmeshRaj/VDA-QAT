...
from old.aimet_qat_init    import build_quant_sim, calibrate_encodings, save_encodings
from old.qat_training_loop import train_qat, DEVICE, BATCH_SIZE, SEQ_LEN
